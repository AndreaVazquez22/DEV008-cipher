...
describe('cipher', () => {
  ...
  describe('cipher.encode', () => {
    ...
    it('should be a function', () => {
      expect(typeof cipher.code).toBe('function');
    });

    it('should throw TypeError when invoked with wrong argument types', () => {
      expect(() => cipher.code()).toThrow(TypeError);
      expect(() => cipher.code(0)).toThrow(TypeError);
      expect(() => cipher.code(null, [])).toThrow(TypeError);
      expect(() => cipher.code(0, 0)).toThrow(TypeError);
    });

    it('should return "HIJKLMNOPQRSTUVWXYZABCDEFG" for "ABCDEFGHIJKLMNOPQRSTUVWXYZ" with offset 33', () => {
      expect(cipher.code(33, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')).toBe('HIJKLMNOPQRSTUVWXYZABCDEFG');
    });
